...
public partial class User_promfeed : System.Web.UI.Page
{
    ...
    protected void sub_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "insert into Feedback values('" + name + "','" + reviewBox.Text + "', 'Prom')";
        cmd.ExecuteNonQuery();
    ...
    {
        Response.Redirect("promfeedview.aspx");
    }
}