<%@ Page Language="C#" AutoEventWireup="true" CodeFile="officer.aspx.cs" Inherits="User_officer" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Officer's Club</title>
    <style>
        body{
...
<p id="follow">Contacts</p>
        ...
        <section>
            <img id="pic" src="Halls/officers.png" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">Officer's Club</p>

            <div id="details">
                <p id="rent">Hall Rent : 1 Lacs Taka</p>
