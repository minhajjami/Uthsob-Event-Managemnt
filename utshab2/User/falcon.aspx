<%@ Page Language="C#" AutoEventWireup="true" CodeFile="falcon.aspx.cs" Inherits="User_falcon" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Falcon Hall</title>
    <style>
        body{
...
<p id="follow">Contacts</p>
        ...
        <section>
            <img id="pic" src="Halls/falcon.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">Falcon Hall</p>

            <div id="details">
                <p id="rent">Hall Rent : 1.5 Lacs Taka</p>
