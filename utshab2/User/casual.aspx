<%@ Page Language="C#" AutoEventWireup="true" CodeFile="casual.aspx.cs" Inherits="User_casual" %>
...
<section>
    <img id="pic" src="party/casual.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">CASUAL BIRTHDAY PARTY</p>

    <div id="details">
        <p>
            উৎসব.কম generally arranges birthday party for the kids. We help to make their day special and fun in our innovative ways. </br></br>
