<%@ Page Language="C#" AutoEventWireup="true" CodeFile="culture.aspx.cs" Inherits="User_culture" %>
...
<section>
    <img id="pic" src="fest/culture2.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">CULTURAL FESTIVAL</p>

    <div id="details">
        <p>
            Bangladesh is a festival loving country. We celebrate different festivals in different times according to our culture. Many educationsl and business organization tends to arrange the cultural festival in their premises. উৎসব.কম helps them to arrange that</br></br>

            উৎসব.কম provides necessary items and decorations for the event and helps to make that a succesful one.</br></br>
        </p>
    </div>
