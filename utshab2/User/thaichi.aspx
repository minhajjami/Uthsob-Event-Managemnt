<%@ Page Language="C#" AutoEventWireup="true" CodeFile="thaichi.aspx.cs" Inherits="User_thaichi" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Thai Chi Restaurant</title>
    <style>
        body{
...
<p id="follow">Contacts</p>
        ...
        <section>
            <img id="pic" src="Halls/thaichi.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">Thai Chi Restaurant</p>

            <div id="details">
                <p id="rent">Hall Rent : 80 Thousand Taka</p>
