<%@ Page Language="C#" AutoEventWireup="true" CodeFile="biye.aspx.cs" Inherits="User_biye" %>
...
<section>
    <img id="pic" src="wedding/biye1.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">WEDDING CEREMONY</p>
    ...
    <div id="details">
        <p>
            ...
            উৎসব.কম offers different packages according to your expectation. From invitation card, decorations, lighting, food, costume, music and all your demands are filled. We keep no stones unturned to make the day special for you. </br></br>
        </p>
    </div>
