...
public partial class User_picnicfeed : System.Web.UI.Page
{
    ...
    protected void sub_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "insert into Feedback values('" + name + "','" + reviewBox.Text + "', 'Picnic')";
        cmd.ExecuteNonQuery();
    ...
    {
        Response.Redirect("picnicfeedview.aspx");
    }
}