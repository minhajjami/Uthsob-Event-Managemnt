...
public partial class User_biyefeed : System.Web.UI.Page
{
    ...
    protected void sub_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "insert into Feedback values('" + name + "','" + reviewBox.Text + "', 'Biye')";
        cmd.ExecuteNonQuery();
    ...
    {
        Response.Redirect("biyefeedview.aspx");
    }
}