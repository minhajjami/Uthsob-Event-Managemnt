<%@ Page Language="C#" AutoEventWireup="true" CodeFile="theme.aspx.cs" Inherits="User_theme" %>
...
<section>
    <img id="pic" src="party/mickey.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">THEME BIRTHDAY PARTY</p>

    <div id="details">
        <p>
            উৎসব.কম generally arranges birthday party for the kids. We help to make their day special and fun in our innovative ways. Theme party is one of the special and unique packages of উৎসব.কম. In this package we keep a theme according to your choice and all the decorations, food items and costumes for the kid and the guests are made according to the theme. </br></br>

            উৎসব.কম offers decorations, food, cake, and costume for the kid. </br></br>
        </p>
    </div>
