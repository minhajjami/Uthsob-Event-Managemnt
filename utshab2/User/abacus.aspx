<%@ Page Language="C#" AutoEventWireup="true" CodeFile="abacus.aspx.cs" Inherits="User_abacus" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Abacus Hall</title>
    <style>
        body{
...
<p id="follow">Contacts</p>
        ...
        <section>
            <img id="pic" src="Halls/abacus.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">Abacus Hall</p>

            <div id="details">
                <p id="rent">Hall Rent : 65 Thousand Taka</p>
