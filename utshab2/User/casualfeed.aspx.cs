...
public partial class User_casualfeed : System.Web.UI.Page
{
    ...
    protected void sub_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "insert into Feedback values('" + name + "','" + reviewBox.Text + "', 'Casual')";
        cmd.ExecuteNonQuery();
    ...
    {
        Response.Redirect("casualfeedview.aspx");
    }
}