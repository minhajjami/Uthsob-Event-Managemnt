...
public partial class User_outdoorfeed : System.Web.UI.Page
{
    ...
    protected void sub_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "insert into Feedback values('" + name + "','" + reviewBox.Text + "', 'Outdoor')";
        cmd.ExecuteNonQuery();
    ...
    {
        Response.Redirect("outdoorfeedview.aspx");
    }
}