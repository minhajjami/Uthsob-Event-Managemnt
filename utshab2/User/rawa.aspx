<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rawa.aspx.cs" Inherits="User_rawa" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Raowa Club</title>
    <style>
        body{
...
<p id="follow">Contacts</p>
        ...
        <section>
            <img id="pic" src="Halls/rawa.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">Raowa Club</p>

            <div id="details">
                <p id="rent">Hall Rent : 2 Lacs Taka</p>
            ...
            <table id="tab">
                ...
                <tr>
                    <td>19th February 2018</td>
                    <td>Booked</td>
                </tr>
                <tr>
                    <td>20th February 2018</td>
                    <td>Booked</td>
                </tr>
                <tr>
