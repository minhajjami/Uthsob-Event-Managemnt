...
public partial class User_indoorfeed : System.Web.UI.Page
{
    ...
    protected void sub_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "insert into Feedback values('" + name + "','" + reviewBox.Text + "', 'Indoor')";
        cmd.ExecuteNonQuery();
    ...
    {
        Response.Redirect("indoorfeedview.aspx");
    }
}