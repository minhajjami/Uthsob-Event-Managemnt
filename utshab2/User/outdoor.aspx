<%@ Page Language="C#" AutoEventWireup="true" CodeFile="outdoor.aspx.cs" Inherits="User_outdoor" %>
...
<section>
    <img id="pic" src="party/outdoor.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">OUTDOOR BUSINESS CONFERENCE</p>

    <div id="details">
        <p>
            উৎসব.কম helps to arrange succesful business conference in the most professional way possible. A business conference is a vital thing in every business organizations. Keeping that in mind উৎসব.কম arranges the event. But sometimes the outdoor conferences are preferred my many as it's casual and also brings a fun in the meeting. We also arrange that.</br></br>
