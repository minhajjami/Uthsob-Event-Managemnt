<%@ Page Language="C#" AutoEventWireup="true" CodeFile="university.aspx.cs" Inherits="User_university" %>
...
<section>
    <img id="pic" src="fest/university.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">UNIVERSITY FESTS</p>

    <div id="details">
        <p>
            Every university does different fests and other events in deifferent times to change the monotonous life of the students. The students perform various performances and also sometimes music band or celebrity are brought in the event.</br></br>

            উৎসব.কম offers the decoration, food items and other necessary items for the event. উৎসব.কম also helps to bring your favorite celebrity or music band in the event.</br></br>
        </p>
    </div>
