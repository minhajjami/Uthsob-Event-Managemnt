<%@ Page Language="C#" AutoEventWireup="true" CodeFile="holud.aspx.cs" Inherits="User_holud" %>
...
<section>
    <img id="pic" src="wedding/holud2.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">গায়ে হলুদ</p>

    <div id="details">
        <p>
            উৎসব.কম mainly gives priority to the wedding occassions. গায়ে হলুদ is one of the major ceremony in every bengali wedding. so উৎসব.কম gcives their maximum effort to make it a good one. </br></br>

            উৎসব.কম offers different packages according to your demand. We offer decorations, food, turmeric items, costume etc. for the event. Also we arrange DJ or any other music system according to your demand.</br></br>
        </p>
    </div>
