<%@ Page Language="C#" AutoEventWireup="true" CodeFile="destination.aspx.cs" Inherits="User_destination" %>
...
<section>
    <img id="pic" src="wedding/destination.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">DESTINATION WEDDING</p>
    ...
    <div id="details">
        <p>
            ...
            Destination wedding is a dream of every couple. Not all event management groups offer this unique opportunity but we do. We take you to your desired location and arrange your ceremony their. উৎসব.কম provides the transport as much as you need to travel to the location along with decorations, food and costume. </br> </br>
        </p>
    </div>
