<%@ Page Language="C#" AutoEventWireup="true" CodeFile="News.aspx.cs" Inherits="User_News" %>
...
<p id="follow">Contacts</p>
    ...
    <ItemTemplate>
        ...
        <div id="rbox">  
                    ...
                    <h2 id="rb1name"><%#Eval("Headline") %></h2> 
          
                  <p id="rb1d"><%#Eval("Content") %></p>  
