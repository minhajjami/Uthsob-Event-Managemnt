<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kunjo.aspx.cs" Inherits="User_kunjo" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Sena Kunja</title>
    <style>
        body{
...
<p id="follow">Contacts</p>
        ...
        <section>
            <img id="pic" src="Halls/kunjo.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">Sena Kunjo</p>

            <div id="details">
                <p id="rent">Hall Rent : 3 Lacs Taka</p>
