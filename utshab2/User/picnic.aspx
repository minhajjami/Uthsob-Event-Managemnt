<%@ Page Language="C#" AutoEventWireup="true" CodeFile="picnic.aspx.cs" Inherits="User_picnic" %>
...
<section>
    <img id="pic" src="fest/picnic2.jpg" alt="logo" width="1000px" height="600px" ;">
    <p id="headline">PICNIC</p>

    <div id="details">
        <p>
            Picnic is a very common event in every organizations. A group of people goes to different spot to have fun the whole day in their special ways. উৎসব.কম helps to make the day more special for them.</br></br>

            উৎসব.কম provides the decorations and food for the picnic. Also we hlep to book your preferable picnic spot.</br></br>
        </p>
    </div>
