...
public partial class User_receptionfeed : System.Web.UI.Page
{
    ...
    protected void sub_Click(object sender, EventArgs e)
    {
        ...
        cmd.CommandText = "insert into Feedback values('" + name + "','" + reviewBox.Text + "', 'Reception')";
        cmd.ExecuteNonQuery();
    ...
    {
        Response.Redirect("receptionfeedview.aspx");
    }
}