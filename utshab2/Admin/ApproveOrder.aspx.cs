...
public partial class Admin_ApproveOrder : System.Web.UI.Page
{
    ...
    protected void Btn_Click(object sender, EventArgs e)
    {
        ...
        SqlCommand cmd = con.CreateCommand();
        cmd.CommandType = CommandType.Text;
        cmd.CommandText = "INSERT INTO Orders(Name, Number, Event, Place, Hall, Date, Time) SELECT Name, Number, Event, Place, Hall, Date, Time FROM BookingForm where BookingForm.Id=" + id ;
        cmd.ExecuteNonQuery();
        //DataTable dt = new DataTable();
        //SqlDataAdapter da = new SqlDataAdapter(cmd);
        //da.Fill(dt);
