<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CancelOrder.aspx.cs" Inherits="Admin_CancelOrder" %>
...
<body>
    ...
    <FooterTemplate>
        ...
        <asp:Button ID="Btn" CssClass="appBtn" runat="server" Text="Delete Order" OnClick="Btn_Click"/>
    </form>
</body>
</html>
